\documentclass{bxjsarticle} % https://github.com/zr-tex8r/BXjscls
\usepackage{luatexja} % https://www.ctan.org/pkg/luatexja
\usepackage{robomech}
\usepackage{graphicx}

% \renewcommand{\refname}{References}   %% Uncomment this line when writing an English paper.
